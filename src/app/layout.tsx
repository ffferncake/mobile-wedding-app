...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://github.com/ffferncake/mobile-wedding-app/blob/main/public/images/gallery/gallery_7.JPG",
        width: 800,
        height: 600,
        alt: "은상 ♥ 펀 웨딩 사진",
      },
  ...
  return (
    <html lang="ko">
      <head>
        ...
        <meta
          property="og:image"
          content="https://fern-eunsang.vercel.app/images/gallery/gallery_7.JPG"
        />
